...
const SupplierDue = ({suppliers,size}) => {
  ...
  /* data = [
    ["Supplier 1", "supplier1@test.com", "8356982415", "Mumbai", "1000", "View Edit Delete"],
    ["Supplier 2", "supplier2@test.com", "8356982415", "Mumbai", "1000", "View Edit Delete"],
    ["Supplier 3", "supplier3@test.com", "8356982415", "Mumbai", "1000", "View Edit Delete"],
    ["Supplier 4", "supplier4@test.com", "8356982415", "Mumbai", "1000", "View Edit Delete"],
    ["Supplier 5", "supplier5@test.com", "8356982415", "Mumbai", "1000", "View Edit Delete"],
   ]; */
  return (
    <div>
      <Head>
